...
enter_new_name = tk.Entry(tab2, textvariable=cashier_new_name, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.2)
tk.Label(tab2, text='请输入新手机号码:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.4)
cashier_new_phone = tk.StringVar()
enter_new_phone = tk.Entry(tab2, textvariable=cashier_new_phone, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.4)
...
enter_customer_id = tk.Entry(tab3, textvariable=customer_id, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.2)
tk.Label(tab3, text='请输入商品号:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.35)
goods_id = tk.StringVar()
enter_goods_id = tk.Entry(tab3, textvariable=goods_id, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.35)
tk.Label(tab3, text='请输入交易数量:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.5)
quantity = tk.StringVar()
enter_quantity = tk.Entry(tab3, textvariable=quantity, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.5)
...
enter_customer_id2 = tk.Entry(tab4, textvariable=customer_id2, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.2)
tk.Label(tab4, text='请输入购买点数:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.4)
point = tk.StringVar()
enter_point = tk.Entry(tab4, textvariable=point, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.4)
...
enter_customer_name = tk.Entry(tab5, textvariable=customer_name, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.2)
tk.Label(tab5, text='请输入顾客电话:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.4)
customer_phone = tk.StringVar()
enter_customer_phone = tk.Entry(tab5, textvariable=customer_phone, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.4)
...
enter_buyer_old_pwd = tk.Entry(tab6, textvariable=buyer_old_pwd, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.2)
...
enter_buyer_new_name = tk.Entry(tab7, textvariable=buyer_new_name, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.2)
tk.Label(tab7, text='请输入新手机号码:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.4)
buyer_new_phone = tk.StringVar()
enter_buyer_new_phone = tk.Entry(tab7, textvariable=buyer_new_phone, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.4)
...
enter_goods_name = tk.Entry(tab8, textvariable=goods_name, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.2)
tk.Label(tab8, text='请输入商品售价:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.35)
goods_price = tk.StringVar()
enter_goods_price = tk.Entry(tab8, textvariable=goods_price, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.35)
tk.Label(tab8, text='请输入商品成本:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.5)
goods_cost = tk.StringVar()
enter_goods_cost = tk.Entry(tab8, textvariable=goods_cost, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.5)
tk.Label(tab8, text='请输入商品类型:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.65)
goods_type = tk.StringVar()
enter_goods_type = tk.Entry(tab8, textvariable=goods_type, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.65)
...
enter_goods_id2 = tk.Entry(tab9, textvariable=goods_id2, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.2)
tk.Label(tab9, text='请输入id:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.35)
buyer_id2 = tk.StringVar()
enter_buyer_id2 = tk.Entry(tab9, textvariable=buyer_id2, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.35)
tk.Label(tab9, text='请输入进货数量:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.5)
add_goods_quantity = tk.StringVar()
enter_add_goods_quantity = tk.Entry(tab9, textvariable=add_goods_quantity, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46,
                                                                                                          rely=0.5)
...
add_goods_quantity_btn.place(relx=0.45, rely=0.65)
...
enter_new_user_type = tk.Entry(tab10, textvariable=new_user_type, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.4)
...
enter_logout_id = tk.Entry(tab11, textvariable=logout_id, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.35)
...
odr = tk.StringVar()
enter_odr = tk.Entry(tab14, textvariable=odr, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.05)
tk.Label(tab14, text='商品类型:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.15)
goods_type = tk.StringVar()
enter_goods_type = tk.Entry(tab14, textvariable=goods_type, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.15)
tk.Label(tab14, text='起始时间:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.25)
start_time = tk.StringVar()
enter_start_time = tk.Entry(tab14, textvariable=start_time, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.25)
tk.Label(tab14, text='截止时间:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.35)
end_time = tk.StringVar()
enter_end_time = tk.Entry(tab14, textvariable=end_time, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.35)
...
enter_vip_start_time = tk.Entry(tab15, textvariable=vip_start_time, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.05)
tk.Label(tab15, text='截止时间:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.15)
vip_end_time = tk.StringVar()
enter_vip_end_time = tk.Entry(tab15, textvariable=vip_end_time, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.15)
...
enter_goods_id3 = tk.Entry(tab16, textvariable=goods_id3, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.05)
...
goods_id4 = tk.StringVar()
enter_goods_id4 = tk.Entry(tab17, textvariable=goods_id4, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.05)
tk.Label(tab17, text='商品新名称:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.15)
new_goods_name = tk.StringVar()
enter_new_goods_name = tk.Entry(tab17, textvariable=new_goods_name, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.15)
tk.Label(tab17, text='商品新售价:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.25)
new_price = tk.StringVar()
enter_new_price = tk.Entry(tab17, textvariable=new_price, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.25)
tk.Label(tab17, text='商品新成本:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.35)
new_cost = tk.StringVar()
enter_new_cost = tk.Entry(tab17, textvariable=new_cost, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.35)
tk.Label(tab17, text='商品新数量:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.45)
new_quantity = tk.StringVar()
enter_new_quantity = tk.Entry(tab17, textvariable=new_quantity, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.46, rely=0.45)
...
enter_start_time1 = tk.Entry(tab18, textvariable=start_time1, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.05)
tk.Label(tab18, text='结束时间:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.15)
end_time1 = tk.StringVar()
enter_end_time1 = tk.Entry(tab18, textvariable=end_time1, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.15)
...
enter_start_time2 = tk.Entry(tab19, textvariable=start_time2, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.05)
tk.Label(tab19, text='结束时间:', font=('潮字社国风冉宋简-闪', 16)).place(relx=0.25, rely=0.15)
end_time2 = tk.StringVar()
enter_end_time2 = tk.Entry(tab19, textvariable=end_time2, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.15)
...
vip_id = tk.StringVar()
enter_vip_id = tk.Entry(tab20, textvariable=vip_id, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.05)
...
enter_customer_id3 = tk.Entry(tab21, textvariable=customer_id3, font=('潮字社国风冉宋简-闪', 16)).place(relx=0.44, rely=0.05)
